...
<body>
    ...
    <div id="preloader">
        <div class="preloader-wrap">
            <img src="../images/Logo/favicon.png" alt="Bumble Bees - Logo" class="img-fluid preloader-icon">
    ...
    <div class="main-wrapper">
        ...
        <section class="sign-up-in-section bg-dark ptb-60" style="background: url('https://quiety.themetags.com/assets/img/page-header-bg.svg')no-repeat right bottom">
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-5 col-md-8 col-12">
                        <a href="index.html" class="mb-4 d-block text-center">                        
                            <img src="../images/Logo/BumbleBees-Logo-White.svg" alt="logo" class="img-fluid Login-BumbleBeesLogo"></a>
                        <div class="register-wrap p-5 bg-light shadow rounded-custom">
                            ...
                            <div class="action-btns">
                                <a href="#" class="btn google-btn bg-white shadow-sm mt-4 d-block d-flex align-items-center text-decoration-none justify-content-center">
                                    <img src="https://quiety.themetags.com/assets/img/google-icon.svg" alt="google" class="me-3">
